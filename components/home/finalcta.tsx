      ...
      <div className="container-x">
        ...
        <Reveal delay={0.15}>
          <div className="mt-12 grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
            <a href="/request-care-assessment" className="group rounded-2xl bg-primary text-primary-foreground p-6 flex flex-col justify-between min-h-45 hover:shadow-2xl transition-all hover:-translate-y-1">
            ...
            <a href="/for-professionals/make-a-referral" className="group rounded-2xl bg-card border border-border p-6 flex flex-col justify-between min-h-45 hover:shadow-xl transition-all hover:-translate-y-1">
